...
@Component({
  ...
  imports: [Button, Card, CardContent, Input, Label, LucideAngularModule],
  template: `
          ...
          <Card class="overflow-hidden p-0">
            <CardContent class="grid p-0 md:grid-cols-2">
              ...
              <div class="bg-muted relative hidden md:block">
                <div
                  class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-muted via-muted/80 to-muted-foreground/20"
                >
                  <lucide-icon
                    [img]="icons.GalleryVerticalEnd"
