          ...
          <CardContent>
            <form>
              ...
              <div class="flex flex-col gap-6">
                ...
                <!-- FieldSeparator -->
                <div class="relative -my-2 h-5 text-sm *:data-[slot=field-separator-content]:bg-card">
                  <div class="absolute inset-0 top-1/2 bg-border h-px w-full"></div>
                  <span
