...
@Component({
  ...
  template: `
    <div class="flex" style="min-height: calc(100vh - var(--site-header-height, 64px))">

      <!-- ─── LEFT SIDEBAR ─────────────────────────────────────── -->
      <aside class="w-72 shrink-0 border-r bg-background flex flex-col overflow-y-auto"
             style="position: sticky; top: var(--site-header-height, 64px); height: calc(100vh - var(--site-header-height, 64px))">
