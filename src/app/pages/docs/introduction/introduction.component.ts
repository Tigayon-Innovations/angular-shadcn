  ...
  template: `
    <article class="relative">
      ...
      <div class="space-y-4 pb-8 pt-6 md:pb-10">
        <div class="space-y-2">
          <h1 class="scroll-m-20 text-4xl font-bold tracking-tight lg:text-5xl">Introduction</h1>
            ...
            <div class="space-y-4 text-base leading-7">
              ...
              <div class="rounded-lg border bg-muted/50 p-6 space-y-3">
                ...
                <p class="text-sm text-muted-foreground">
                  We follow the same design principles, naming conventions, and API patterns to
                  ensure familiarity for developers coming from React.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
              <div class="rounded-lg border bg-card p-6 space-y-3">
                ...
                <p class="text-sm text-muted-foreground leading-relaxed">
                  Copy the components you need. You own the code. Modify, extend, or remove as you
                  see fit.
                </p>
              </div>
              <div class="rounded-lg border bg-card p-6 space-y-3">
                <div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center">
                  <svg
                    ...
                    class="text-primary"
                  >
                    <path d="M2.5 2.5h19v19h-19z M7 12h10 M12 7v10" />
                  </svg>
                </div>
              ...
              <div class="rounded-lg border bg-card p-6 space-y-3">
                ...
                <p class="text-sm text-muted-foreground leading-relaxed">
                  No runtime component library bloat. Just Angular and Tailwind CSS — tools you
                  already know.
                </p>
              </div>
              <div class="rounded-lg border bg-card p-6 space-y-3">
                <div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center">
                  <svg
                    ...
                    class="text-primary"
                  >
                    <path d="M9 12h6 M12 9v6 M2 12a10 10 0 1 0 20 0 10 10 0 1 0-20 0" />
                  </svg>
                </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
              ...
              >
                <div class="space-y-3">
                  ...
                  <p class="text-sm text-muted-foreground leading-relaxed">
                    Latest Tailwind v4 with CSS variables for effortless theming and built-in dark
                    mode.
                  </p>
                </div>
              </div>
              ...
              >
                <div class="space-y-3">
                  ...
                  <p class="text-sm text-muted-foreground leading-relaxed">
                    Strict TypeScript with full type safety. No
                    <code class="bg-muted px-1.5 py-0.5 rounded text-xs">any</code> in the public
                    API.
                  </p>
                </div>
              </div>
              ...
              >
                <div class="space-y-3">
                  ...
                  <p class="text-sm text-muted-foreground leading-relaxed">
                    Comprehensive set of components for forms, navigation, feedback, data display,
                    and more.
                  </p>
                </div>
              </div>
        ...
        <section class="scroll-mt-20">
          <div class="space-y-6">
            <div class="space-y-2">
              ...
              <p class="text-muted-foreground">Standing on the shoulders of giants.</p>
            </div>
            <div class="space-y-4">
              <div class="rounded-lg border p-4 flex items-start gap-4">
                ...
                <div>
                  <a
                    href="https://ui.shadcn.com"
                    target="_blank"
                    class="font-semibold underline underline-offset-4 hover:text-primary"
                  >
                    shadcn/ui
                  </a>
