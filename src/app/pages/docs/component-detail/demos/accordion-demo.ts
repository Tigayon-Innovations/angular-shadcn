  ...
  template: `
    <Accordion type="single" collapsible class="w-full max-w-md">
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          Yes. It comes with default styles that match the shadcn/ui aesthetic. You can customize it
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          Yes. It's animated by default with smooth expand/collapse transitions powered by CSS
          animations.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
