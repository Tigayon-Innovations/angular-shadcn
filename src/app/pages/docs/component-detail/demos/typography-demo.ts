  ...
  template: `
    <article class="prose prose-invert max-w-2xl space-y-4">
      ...
      <TypographyLead class="block">
        ...
        day lounging on his throne.
      </TypographyLead>
      <TypographyH2 class="block mt-8">The King's Plan</TypographyH2>
      <TypographyP class="block">
        The king thought it was a brilliant idea to tax jokes. "After all," he said,
        "everyone enjoys a good joke, so why not profit from it?"
      </TypographyP>
      <TypographyP class="block">
      ...
      <TypographyBlockquote class="block my-6">
        ...
        the kingdom benefits too."
      </TypographyBlockquote>
      <TypographyH3 class="block mt-8">The Consequences</TypographyH3>
      <TypographyP class="block">
        The people were not happy. Comedians went underground, jesters fled the
        kingdom, and laughter became a rare commodity.
      </TypographyP>
