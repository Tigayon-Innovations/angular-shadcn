...
export {
    ComponentDocsRegistry, type AccessibilityInfo, type ComponentApiReference, type ComponentDocumentation, type DocumentationExample
} from './component-docs';
export {
...
export { SeoService, type SeoConfig } from './seo.service';
