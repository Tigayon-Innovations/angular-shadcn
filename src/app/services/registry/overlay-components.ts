...
<div class="data-[state=open]:animate-in data-[state=closed]:animate-out
    ...
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'true',
        description: 'Whether the dialog blocks interaction with outside elements.',
        component: 'Dialog',
      },
      {
        name: 'class',
      ...
      },
      {
        name: 'initialFocus',
        type: 'string',
        description: 'Selector for the element to focus on open.',
        component: 'DialogContent',
      },
    ],
  },
  ...
  <DrawerContent>
    ...
    props: [{ name: 'open', type: 'boolean', description: 'Whether the drawer is open.' }],
  },
  {
    name: 'Hover Card',
    slug: 'hover-card',
  ...
  },
  {
    ...
    slug: 'popover',
    description:
      'Displays rich content in a portal, triggered by a button. Supports positioning and collision detection.',
    category: 'overlay',
...
<div class="animate-in slide-in-from-bottom data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom">`,
  ...
  },
  {
    ...
    slug: 'toast',
    description:
      'A succinct message displayed temporarily. Supports variants, actions, and custom positioning.',
    category: 'overlay',
    package: '@ng-cn/toast',
  ...
  setTimeout(() => {
    ...
    props: [
      ...
      },
      {
        ...
        description: 'Toast viewport position.',
        component: 'Toaster',
      },
    ],
  },
  ...
  <p>Animated tooltip</p>
    ...
    props: [
      ...
      },
      {
        ...
        type: 'number',
        default: '300',
        description: 'Time to skip delay when moving to another tooltip.',
        component: 'TooltipProvider',
      },
      {
        name: 'side',
