...
This file defines strict legal-safe defaults for recruitment and immigration messaging.

## Non-Negotiable Rules

- Do not guarantee visa approvals.
- Do not guarantee job placement outcomes.
- Do not claim specific processing speed without verifiable source and scope.
- Do not use universal success claims.
- Do not provide legal conclusions unless explicitly approved legal language exists.
...
- Explicit timeframe qualifiers with source context.
...
Only use these with auditable evidence and a named basis.
...
- CTA remains clear after compliance edits.
